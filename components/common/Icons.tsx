...
export const BrainCircuitIcon = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 5a3 3 0 1 0-5.993.13a3 3 0 0 0 5.993-.13Zm0 0a3 3 0 1 0 5.993.13a3 3 0 0 0-5.993-.13Z"/><path d="M12 12a3 3 0 1 0-5.993.13a3 3 0 0 0 5.993-.13Zm0 0a3 3 0 1 0 5.993.13a3 3 0 0 0-5.993-.13Z"/><path d="M12 19a3 3 0 1 0-5.993.13a3 3 0 0 0 5.993-.13Zm0 0a3 3 0 1 0 5.993.13a3 3 0 0 0-5.993-.13Z"/><path d="M12 5a3 3 0 0 0-3 3v1"/><path d="M12 12a3 3 0 0 0-3 3v1"/><path d="M12 5a3 3 0 0 1 3 3v1"/><path d="M12 12a3 3 0 0 1 3 3v1"/><path d="m14.5 6.5-5 4"/><path d="m14.5 13.5-5 4"/>
  </svg>
);
export const StethoscopeIcon = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M4.8 2.3A.3.3 0 1 0 5.4 2a.3.3 0 0 0-.6.3"/><path d="M8 3a1 1 0 0 0-1 1v2"/><path d="M17 3a1 1 0 0 1 1 1v2"/><path d="M7 6v12a5 5 0 0 0 5 5v0a5 5 0 0 0 5-5V6"/><path d="M20 12a8 8 0 1 1-16 0"/>
  </svg>
);
export const UserCogIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <circle cx="18" cy="15" r="3" /><circle cx="9" cy="7" r="4" /><path d="M12 15h-1a7 7 0 0 0-7 7" /><path d="m19.5 17.5-2-2" /><path d="m21 13-2 2" /><path d="m15.5 16-1-1" /><path d="M17 13.5v-1" /><path d="M20 15h-1" />
    </svg>
);
...
export const HL7Icon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M4 12h16"/><path d="M4 18h16"/><path d="M4 6h16"/></svg>
);
export const DicomIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><path d="M8 12h8"/><path d="M8 16h8"/><path d="M10 12v4"/></svg>
);
export const ApiIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m16 18 6-6-6-6"/><path d="m8 6-6 6 6 6"/><path d="m15 4-5 16"/></svg>
);
...
export const FileWarningIcon = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const BookOpenCheckIcon = ({ className }: IconProps) => (
